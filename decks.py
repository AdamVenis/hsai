...
starter = ['Leper Gnome', 'Leper Gnome', 'Novice Engineer', 
         ...
         'River Crocolisk', 'River Crocolisk', 'Ironfur Grizzly',
         'Ironfur Grizzly', 'Wolfrider', 'Wolfrider', 'Harvest Golem',
         'Harvest Golem', 'Earthen Ring Farseer', 'Earthen Ring Farseer',
         'Chillwind Yeti', 'Chillwind Yeti', 'Gnomish Inventor',
...
default_mage = ['Arcane Missles', 'Arcane Missles',
               ...
               'Raid Leader', 'Raid Leader', 'Wolfrider', 'Wolfrider',
